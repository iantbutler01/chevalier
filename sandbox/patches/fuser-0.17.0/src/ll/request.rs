...
mod op {
    ...
    impl GetLk<'_> {
        ...
        pub(crate) fn lock_namespace(&self) -> crate::LockNamespace {
            if self.arg.lk_flags & crate::consts::FUSE_LK_FLOCK != 0 {
                crate::LockNamespace::Flock
            } else {
                crate::LockNamespace::Posix
            }
        }
    }
